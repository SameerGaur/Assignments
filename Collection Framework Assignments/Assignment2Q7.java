...
class Parked_CarOwnerList extends Assignment2Q7{
    int id = 1;
    int levels = 3;
    int sections = 4;
    int slots = 20;
    Map<Integer,Assignment2Q7> car = new HashMap<>();
    Map<Integer,ParkingSlot> parkingSlotMap = new HashMap<>();

    public void add_new_car(Assignment2Q7 obj){
    ...
    public void remove_car(String name,int carNo){
        int key = 0;
        for (Map.Entry<Integer, Assignment2Q7> mp: car.entrySet()){
            Assignment2Q7 obj = mp.getValue();
   ...
   String carModel;
    ...
    public void menu(){
        ...
        do{
            ...
            choice = sc.nextInt();
            switch (choice){
                case 1: Parked_CarOwnerList.add_new_car(new Assignment2Q7());
                        break;
                case 2: String name;
                int number;
                    ...
                    number = sc.nextInt();
                        ...
                        Parked_CarOwnerList.remove_car(name,number);
                        break;
                case 3:
                    System.out.println(Parked_CarOwnerList.get_parked_car_location(101));
                    break;
                case 4:
                    System.exit(0);
