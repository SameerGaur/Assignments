...
public class Assignment1Q3 {
    ...
    public static void main(String[] args) {
        ...
        Trader trader1 = new Trader("Advait","Pune");
        Trader trader2 = new Trader("Hritik","Bangalore");
        Trader trader3 = new Trader("Saurabh","Pune");
        Trader trader4 = new Trader("Raj","Pune");
        Trader trader5 = new Trader("Vaibhav","Indore");
        Trader trader6 = new Trader("Hari","Indore");
